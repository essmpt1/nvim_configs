...
vim.keymap.set("n", "<Tab>", ":bnext<CR>", { silent = true, desc = "Mover" })
...
vim.keymap.set('n', '<leader>gc', ':Telescope git_commits<CR>', { noremap = true, silent = true, desc="Histórico de commits do repositório" })
vim.keymap.set('n', '<leader>gf', ':DiffviewFileHistory %<CR>', { noremap = true, silent = true, desc="Histórico de commits do arquivo atual" })
vim.keymap.set('n', '<leader>gd', ':DiffviewOpen<CR>', { noremap = true, silent = true, desc="Abrir visualização detalhada de diffs" })
vim.keymap.set('n', '<leader>gq', ':DiffviewClose<CR>', { noremap = true, silent = true, desc="Fechar a visualização do Diffview" })
